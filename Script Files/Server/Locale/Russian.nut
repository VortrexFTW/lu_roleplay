return {
    ...
    LocaleAvailable = "На этом сервере имеется перевод на русском языке" , // Put the language name here
    LocaleRegionUse = "Использовать / regionlocale, чтобы использовать этот перевод" , 
    ...
    LanguageSet = "Ваш язык установлен на русском языке" , // Put the language name here
