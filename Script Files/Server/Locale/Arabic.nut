return {
	...
	LocaleAvailable = "يتوفر هذا الخادم باللغة العربية" , // Put the language name here
	LocaleRegionUse = "استخدم /RegionLocale لاستخدام هذه الترجمة" , 
	...
	LanguageSet = "يتم تعيين لغتك الآن إلى العربية" ,  // Put the language name here
